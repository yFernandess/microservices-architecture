...
namespace GeekShopping.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            _user.CreateAsync(admin, "Fernandes123$").GetAwaiter().GetResult();
            ...
            {
                UserName = "yuri-client",
                Email = "yuri-client@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (48) 12345-6789",
                FirstName = "Yuri",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Fernandes123$").GetAwaiter().GetResult();
